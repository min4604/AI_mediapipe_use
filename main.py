...
def play_specific_music(music_file):
    # 初始化 Pygame
    pygame.init()
            ...
            if time.time() - presstime > 1:
                ...
                # control keyboard
                    ...
                    if time.time() - presstime_2 > 1:
                        ...
                        control_keyboard(most_common_keypoint_id, 6, 'left', keyboard_TF=True, print_TF=True)
                        presstime_2 = time.time()   #down
                    ...
                    # 動態手勢控制
                    if most_common_fg_id[0][0] == 3 and most_common_fg_id[0][1] > 12:
                        if time.time() - presstime_3 > 3:
                            #pyautogui.press(['shift', '>'])
                            #pyautogui.hotkey('shift', '>')
                            pyautogui.press('right')
                            print('next')
                            presstime_3 = time.time()
                    #elif most_common_fg_id[0][0] == 4 and most_common_fg_id[0][1] > 12:
